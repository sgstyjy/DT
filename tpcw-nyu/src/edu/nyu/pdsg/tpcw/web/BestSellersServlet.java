...
/**
 * Best Sellers Servlet.
 * 
 * @author <a href="mailto:totok@cs.nyu.edu">Alexander Totok</a>
 * 
 * @version   $Revision: 1.4 $   $Date: 2005/02/05 21:26:28 $   $Author: totok $
 */
public class BestSellersServlet extends TPCWServlet {
	...
	public void serveRequest(HttpServletRequest req, PrintWriter out) throws ServletException {
		...
		try {
			books = catalog.searchRecentlyPurchasedItemsBySubject(subject, Constants.RECENT_ORDERS_LIMIT, Constants.SEARCH_LIMIT);
