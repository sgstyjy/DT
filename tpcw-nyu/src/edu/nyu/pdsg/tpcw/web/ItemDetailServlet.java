...
public class ItemDetailServlet extends TPCWServlet {
    ...
    public void serveRequest(HttpServletRequest request, PrintWriter out) throws ServletException {
        ...
        out.println("<CENTER><A HREF=\"cart?ACTION=ADD&I_ID=" + I_ID + "&QTY=1\">");
        out.println("<IMG SRC=\"images/add_B.gif\" ALT=\"Add to Basket\"></A>");
        
        out.println("<A HREF=\"search\">");
        ...
        out.println("<A HREF=\"admin?I_ID=" + I_ID + "\">");
