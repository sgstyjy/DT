...
public abstract class TPCWServlet extends HttpServlet {
	...
	protected void displayPromotions(HttpServletRequest request, PrintWriter out, Random rand) throws ServletException {
		...
		for (int i = 0; i < v.size(); i+=2) {
			out.println("<TD><A HREF=\"item?I_ID=" + v.elementAt(i));
	 ...
	 */    
    protected abstract void serveRequest(HttpServletRequest request, PrintWriter out) throws ServletException;
